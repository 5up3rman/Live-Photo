...
namespace Paragon.Foundation.LivePhoto.ContentEditor.Fields
{
    /// <summary>
    /// Based on the Sitecore.Shell.Applications.ContentEditor.Image Control
    /// </summary>
    public class LivePhotoFieldControl : LinkBase
    {
        ...
        public override void HandleMessage(Message message)
        {
            ...
            switch (message.Name)
            {
                case "contentimage:open":
                    Browse();
                    break;
                case "livephoto:browsemovie":
                    BrowseMovie();
                    break;
                case "livephoto:showproperties":
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            ServerProperties["MovieValue"] = ServerProperties["MovieValue"];
        }
        ...
        protected void BrowseAssociatedMovie(ClientPipelineArgs args)
        {
            if (args.IsPostBack)
            {
                ...
                var movieItem = (MediaItem) Client.ContentDatabase.Items[args.Result];

                if (movieItem != null)
                {
                    XmlValue.SetAttribute("movieid", movieItem.ID.ToString());
                    AssociatedMovieValue = movieItem.MediaPath;
                    SetModified();
                }
                else
            ...
            else
            {
                ...
                {MovieValue, "/sitecore/media library"}), true);
                args.WaitForPostBack();
            }
        }
        ...
        public string MovieValue
        {
            ...
            set
            {
                ...
                SetViewStateString("MovieValue", str);
            }
        }
